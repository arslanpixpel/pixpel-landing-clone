    ...
    <div>
      ...
      <div data-custom-class="body">
            ...
            <strong>
              <span style={{ fontSize: "15px" }}>
                <span data-custom-class="subtitle">
                  Last updated <span className="question">March 23, 2024</span>
                </span>
              </span>
            </strong>
          </span>
          ...
          <span style={{ color: "rgb(127, 127, 127)" }}>
            <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
              ...
              <span data-custom-class="body_text">
                ...
                <strong>process</strong>'<span className="else-block" />) your
          ...
          <span style={{ fontSize: "15px" }}>
            <span style={{ color: "rgb(127, 127, 127)" }}>
              <span data-custom-class="body_text">
                ...
                <span className="question">Support@pixpel.io</span>.
              </span>
            </span>
          </span>
        </div>
        ...
        <div style={{ lineHeight: "1.5" }}>
          <span style={{ fontSize: "15px" }}>
            <span data-custom-class="body_text">
              ...
              <span className="block-component" />
              organisational
              <span className="else-block" /> and technical processes and
              ...
              <span className="block-component" />
              unauthorised
              <span className="else-block" /> third parties will not be able to
        ...
        <div style={{ lineHeight: "1.5" }}>
          ...
          <a
            data-custom-class="link"
            href="https://app.termly.io/notify/9d2c32eb-ede4-4175-be70-23d443fdb9bd"
          ...
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                <span className="question">Revolut</span>
                <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                  <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                    <span data-custom-class="body_text">
                      <span
                      ...
                      <span style={{ color: "rgb(0, 58, 250)" }}>
                        <span className="question">
                          <a
                            href="https://www.revolut.com/en-BG/privacy-policy/"
                            target="_blank"
                            data-custom-class="link"
                          >
                            https://www.revolut.com/en-BG/privacy-policy/
                          </a>
                        </span>
                      </span>
                      <span
          ...
          <li style={{ lineHeight: "1.5" }}>
            <span style={{ fontSize: "15px" }}>
              <span data-custom-class="body_text">
                ...
                <span className="forloop-component" />
                <span className="question">storage</span>,{" "}
                <span className="forloop-component" />
                    ...
                    <span data-custom-class="body_text">
                      <span style={{ fontSize: "15px" }}>
                        <strong>
                          ...
                          fulfil
                          <span className="else-block" /> and manage your
                          orders.
                        </strong>{" "}
                        We may process your information to{" "}
                        <span className="block-component" />
                        fulfil
                        <span className="else-block" /> and manage your orders,
                ...
                <div style={{ lineHeight: "1.5" }}>
                  ...
                  <ul>
                    <li style={{ lineHeight: "1.5" }}>
                      ...
                      <a data-custom-class="link" href="#privacyrights">
                        <span
                          style={{ fontSize: "15px", color: "rgb(0, 58, 250)" }}
                        >
                          <span
                            style={{
                              fontSize: "15px",
                      ...
                      <li style={{ lineHeight: "1.5" }}>
                        <span style={{ fontSize: "15px" }}>
                          <span data-custom-class="body_text">
                            ...
                            display <span className="block-component" />
                            personalised
                            <span className="else-block" /> content and
                                    ...
                                    <li style={{ lineHeight: "1.5" }}>
                                      <span style={{ fontSize: "15px" }}>
                                        ...
                                        <span data-custom-class="body_text">
                                          ...
                                          with Google Analytics to track and{" "}
                                          <span className="block-component" />
                                          analyse
                                          ...
                                          Features that we may use include:{" "}
                                          <span className="forloop-component" />
                                          <span className="block-component" />
                                          <span className="question">
                                          ...
                                          and Ad Settings for mobile apps. Other
                                        ...
                                        >
                                          ...
                                          >
                                            <span data-custom-class="body_text">
                                              ...
                                              and to reject cookies. If you
                                              choose to remove cookies or reject
