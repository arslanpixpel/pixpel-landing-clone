...
function Bottom() {
  ...
  return (
    <>
      ...
      {/* MAIN FOOTER */}
      <div
        id="footer-bottom-main"
        className="flex flex-col bg-app-black 2xl:px-20 xl:px-16 lg:px-12 md:px-9 sm:px-6 px-3 xl:pt-16 lg:pt-12 md:pt-9 sm:pt-6 pt-3 xl:pb-8 lg:pb-6 md:pb-4 pb-3 mt-10 text-white"
      >
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-9">
                <a
                  rel="facebook"
                  href="https://www.facebook.com/PixpelPlatform/"
                >
                  <img
                    src={Facebook}
